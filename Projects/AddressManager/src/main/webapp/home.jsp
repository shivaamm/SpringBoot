...
<div class="container">
  ...
  <div class="login-contianer">
      <div class="bg_top">
        <h2 class="welcome">Address book</h2>
     ...
     <div class="form-cc">
        <div class="col-sm-12 col-md-12">
         <div class="col-md-6 m-auto">
          ...
          <div class="userloginheading">Enter Details</div>
          </div>
        <form>
  <div class="form-group row">
    ...
    <div class="col-sm-12 width100 mt40 text-center">
      <button type="submit" class="submitbtn btn btn-primary"><a> Submit</a></button>
      </form>
      ...
      <!--<a id="show" class="col-md-12 pull-left anchr">Dark Night</a>-->
          ...
          <div class="userloginheading">File Details</div>
          </div>
  <div class="form-group row">
    <div class="col-sm-12">
      <input type="file" name="fil" class="form-control" id="inputPassword3" placeholder="file">
      
    </div>
  </div>
   <div class="form-group row">
    <div class="col-sm-12 width100 mt40 text-center">
      <button type="submit" class="submitbtn btn btn-primary"><a> Upload</a></button>
      </form>
      ...
      <div class="form-cc">
        <div class="col-sm-12 col-md-12">
         <div class="col-md-6 m-auto">
          ...
          <div class="userloginheading">Search</div>
          </div>
        <form>
  <div class="form-group row">
    <div class="col-sm-12">
  ...
  <script>
    ...
    function geocode(e){
      ...
      axios.get('https://maps.googleapis.com/maps/api/geocode/json',{
        params:{
          address:location,
          key:'AIzaSyB7-gwN48voDBmzIicxsRat9eHTni1AMOM'
        }
      })
